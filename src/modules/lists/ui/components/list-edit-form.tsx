...
import { ItemStatus, ItemVisibility, List } from "@prisma/client";
...
export const ListEditForm = ({ list }: ListEditFormProps) => {
  ...
  const editListMutationOptions = trpc.list.edit.mutationOptions({
    onSuccess: () => {
  ...
  const editListMutate = useMutation(editListMutationOptions);
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)}>
        ...
        <div className="flex justify-end mt-4">
          <Button
            type="submit"
            disabled={form.formState.isSubmitting || editListMutate.isPending}
            size="lg"
          >
            {editListMutate.isPending ? (
              <>
